...
//Core1
    ...
    void loop1() {
        //Joystick
            ...
            Joystick.sliderRight(constrain(map(analogRead(joystick2), 600, 860, 0, 1000), 0, 1000));         // Usage: Joystick.'axis'(constrain(map(analogRead('pin'), 'min', 'max', 'min', 'max'), 'min', 'max'));
        ...
        //Dev
            ...
            int yValue = constrain(map(analogRead(joystick2), 600, 860, 0, 1000), 0, 1000);        // Read the Rz-axis value from the joystick
